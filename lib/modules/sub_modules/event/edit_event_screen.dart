...
class _EditEventScreenState extends State<EditEventScreen> {
  ...
  void initState() {
    super.initState();
    _currentCategoryIndex = widget.event.categoryId;
    nameController.text = widget.event.name;
    descriptionController.text = widget.event.description;
    dateSelected = widget.event.date;
    timeSelected = widget.event.time;
  }
              ...
              children: [
                ...
                CustomButton(
                  onPressed: () async {
                    ...
                    final isCreated = await FirebaseFirestoreUtil.editEvent(
                      event: EventModel(
                        id: widget.event.id,
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      lang.event_edit_screen_button_text,
