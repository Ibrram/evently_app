...
import 'package:evently_task_app/modules/onboarding/initial_screen.dart';
import 'package:evently_task_app/modules/onboarding/onboard_screen.dart';
...
abstract class AppRoutes {
  static Route<dynamic> onGenerateRoutes(RouteSettings settings) {
    switch (settings.name) {
      ...
      //
      case RoutesName.initialOnBoard:
        return MaterialPageRoute(
